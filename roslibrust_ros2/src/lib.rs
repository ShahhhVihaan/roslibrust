...
mod tests {
    ...
    fn test_deserialize_hello_world() {
        ...
        let zenoh_bytes :[u8; _] = [
            0x00, 0x01, 0x00, 0x00, 0x0c, 0x00, 0x00, 0x00, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x20, 0x57, 0x6f, 0x72, 0x6c, 0x64, 0x00,
        ];
        ...
        // Serialize
        let serialized = cdr::serialize::<_, _, cdr::CdrLe>(&StdMsgString {
